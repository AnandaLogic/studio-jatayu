...
@Component({
  selector: 'app-girl-and-the-monster',
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: './girl-and-the-monster.component.html',
  styleUrls: ['./girl-and-the-monster.component.css']
})
export class GirlAndTheMonsterComponent {
